...
Teams.prototype = {
  ...
  findMemberByIdSocialProfiles: function (organizationId, teamId, memberId) {
    var path = util.createPath('organizations', organizationId, 'teams', teamId, 'members', memberId, 'socialProfiles');
    return this._connection.get(path, { _method: 'GET' });
  },
}
