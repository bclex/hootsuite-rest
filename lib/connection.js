...
Connection.prototype.getFrameAuthToken = function (url) {
      ...
      rest.post(baseUrl + '/auth/oauth/v2/token', options)
        .on('success', function (data, resp) {
          if (frameCtx) {
            ...
            this.getOnBehalfAuthToken(data).then(function (token) {
              defer.resolve(token);
            }).catch(function (data) {
              defer.reject(data);
            });
...
Connection.prototype.getOnBehalfAuthToken = function (tokenData) {
